...
public class consultadeProyectosenEquiposporcbx extends javax.swing.JFrame {


    public consultadeProyectosenEquiposporcbx() {
        initComponents();
        this.setTitle("Consulta de Proyectos en Equipos"); /// Nombre 
        ...
        for (Equipos e : Login.equipos) {
            cbxProyectos.addItem(e.getNombre());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CONSULTAR PROYECTOS DEL EQUIPO");
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        consultadeProyectosenEquipos consultar = new consultadeProyectosenEquipos(cbxProyectos.getSelectedItem().toString());
